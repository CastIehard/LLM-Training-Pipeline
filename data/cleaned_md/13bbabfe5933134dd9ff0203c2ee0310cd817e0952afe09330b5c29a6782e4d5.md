...
1. Die nachfolgenden allgemeinen Geschäftsbedingungen (nachfolgend „AGB“ genannt) der gutefrage.net GmbH, Erika-Mann-Str. 23, 80636 München (nachfolgend „gutefrage“ oder „wir“ genannt) regeln die rechtlichen Beziehungen zwischen gutefrage und den Nutzern, die auf die Online-Plattform sowie die Mobilen Applikationen von gutefrage zugreifen (nachfolgend zusammenfassend „Plattform“ genannt). Die Nutzung der Plattform und ihrer Funktionen ist kostenlos und nur zulässig, wenn der Nutzer diese Nutzungsbedingungen akzeptiert.
...
1. gutefrage ist sich der Sensibilität persönlicher Daten sowie des Schutzes der Privatsphäre bewusst. Personenbezogene Daten werden im Einklang mit den gesetzlichen Regelungen erhoben, verarbeitet und genutzt. Die Einzelheiten ergeben sich aus unserer Datenschutzbestimmung.
...
4. gutefrage ist ferner berechtigt, die Inhalte der Plattform auf Webseiten unter anderen von gutefrage betriebenen Domainadressen (z.B. und mobilen Applikationen sowie in Verbindung mit gutefrage auf Dritt-Webseiten (z.B. durch Einbindung von Widgets) öffentlich zugänglich zu machen.

ARIA Authoring Practices Guide (APG) How to build accessibility semantics into web patterns and widgets W3C homepage Web Accessibility Initiative (WAI) homepage
> * APG Home
> * Patterns
> * Practices
> * Index
...
> Keyboard Support The example combobox on this page implements the following keyboard interface. Other variations and options for the keyboard interface are described in the Keyboard Interaction section of the Combobox Pattern. Textbox Key | Function
> ---|---
> `Down Arrow` |
...
>
> Help improve this page Please share your ideas, suggestions, or comments via e-mail to the publicly-archived list public-aria-practices@w3.org or via GitHub. E-mailFork & Edit on GitHubNew GitHub Issue Back to Top View issues related to this example Page last updated: 12 August 2025 W3C Web Accessibility Initiative (WAI) Strategies, standards, resources to make the Web accessible to people with disabilities
> * Get News in Email
> * LinkedIn
> * Mastodon
> * YouTube

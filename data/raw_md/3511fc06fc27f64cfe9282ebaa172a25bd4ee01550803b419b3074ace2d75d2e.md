...
![question mark](/webassets/aidworld/images/icons/questionmark-yellow.svg)
...
###  ${ "Folgende Beratungsstellen haben wir %location% gefunden".replace('%location%', 'im ' + state) } ${ "Folgende Beratungsstellen haben wir für %location% gefunden".replace('%location%', state) } ${ "Folgende Beratungsstellen haben wir für %location% gefunden".replace('%location%', (location ? location : searchQuery)) } Folgende Beratungsstellen haben wir gefunden  ${ "Folgende Beratungsstellen haben wir für %location% gefunden".replace('%location%', getCountryName(country)) }
  ...
  * Alle (${ countByFilter(null, null) })
  * ${ getTranslation('type.' + filter) } (${ countByFilter(filter, languageFilter) })
...
*Ortszeit Deutschland *Ortszeit
  ...
  * Diese Seite teilen:
  * [_![Icon: Facebook](/webassets/aidworld/images/social-icons/facebook_blue_100.png)_](https://www.facebook.com/dialog/share?app_id=966242223397117&href=https://www.anerkennung-in-deutschland.de/html/de/beratungssuche.php&t=Anerkennung+in+Deutschland)
  * [_![Icon: LinkedIn](/webassets/aidworld/images/social-icons/linkedin.png)_](https://www.linkedin.com/shareArticle?mini=true&url=https://www.anerkennung-in-deutschland.de/html/de/beratungssuche.php&source=www.anerkennung-in-deutschland.de&title=Anerkennung+in+Deutschland&summary=Lassen+Sie+sich+pers%26ouml%3Bnlich+beraten+und+bei+der+Anerkennung+unterst%26uuml%3Btzen%21+Finden+Sie+hier+die+Beratungsstelle+in+Ihrer+N%26auml%3Bhe.)
  * [_![Icon: WhatsApp](/webassets/aidworld/images/social-icons/whatsapp.png)_](https://api.whatsapp.com/send?text=https://www.anerkennung-in-deutschland.de/html/de/beratungssuche.php)

...
Technische Information zu den einzelnen Verfahren finden Sie unter [Datensicherheit](/eportal/helpGlobal?themaGlobal=help_datasecurity_eop) und [IT-Sicherheit](/eportal/helpGlobal?themaGlobal=help_techsecurity).

#### Ich habe meine Steuererklärung authentifiziert mit meinem Zertifikat aus Mein ELSTER oder einem anderen Steuerprogramm abgegeben, finde aber keine Bestätigung der Abgabe in meinem Posteingang bzw. unter Übermittelte Formulare in Mein ELSTER.
...
[Handbuch zu ElsterAuthenticator](https://download.elster.de/download/authenticator/ElsterAuthenticator-Benutzerhandbuch.pdf "Link öffnet neues Fenster")

#### Welche Authentisierungsverfahren und welche Betriebssysteme werden unterstützt?

Der ElsterAuthenticator kann nur zusammen mit Sicherheitssticks und Signaturkarten verwendet werden. Unterstützt werden die Betriebssysteme Windows, MacOS und Linux Ubuntu. Detaillierte Informationen zu den unterstützten Konfigurationen finden Sie auf [www.sicherheitsstick.de](https://www.sicherheitsstick.de/technik.html "Link öffnet neues Fenster").
...
Gegebenenfalls schränken Firewall-Einstellungen den Zugriff des ElsterAuthenticator auf Mein ELSTER ein. In diesem Fall muss der Zugriff auf den Host [www.elster.de](http://www.elster.de "Link öffnet neues Fenster"), Port 443, Protokoll TCP freigeschaltet werden.  
...
Optional: Laden Sie sich von [www.sicherheitsstick.de](https://www.sicherheitsstick.de/technik.html "Link öffnet neues Fenster") das Programm zum Setzen der Registrierungswerte des Sicherheitssticks herunter und führen dieses mit einem Doppelklick aus. Die Registrierwerte adressieren die Smartcard-Initialisierung von Windows. Dadurch wird der oben genannte Warnhinweis nicht mehr angezeigt.

#### Wie aktiviere ich mein Konto bei Nutzung eines Windows Terminal Servers?
...
Um den Sicherheitsstick verwenden zu können, müssen Sie zusätzliche Software installieren, die Sie unter [www.sicherheitsstick.de](https://www.sicherheitsstick.de/technik.html "Link öffnet neues Fenster") herunterladen können.   
...
Nein, zurzeit können Sie die Sicherheitssticks nur in [diesem Shop](https://www.sicherheitsstick.de/ "Link öffnet neues Fenster") erwerben.

#### Ich möchte den Sicherheitsstick unter einem 64-Bit-Betriebssystem nutzen. Was muss ich hierbei beachten?

Der Sicherheitsstick unterstützt 64-Bit Betriebssysteme. Mehr zu den unterstützten Treibern bei 64-Bit-Betriebssystemen finden Sie unter [www.sicherheitsstick.de](https://www.sicherheitsstick.de/technik.html "Link öffnet neues Fenster").
...
Um den Sicherheitsstick unter Linux Ubuntu einzusetzen, müssen bestimmte Systempakete bzw. Bibliotheken vorhanden sein. Bitte folgen Sie den Installationsanleitungen zur Inbetriebnahme des Sicherheitssticks, die Sie unter [www.sicherheitsstick.de](https://www.sicherheitsstick.de/technik.html "Link öffnet neues Fenster") finden können.
...
Mit ElsterSecure können Sie sich jederzeit in Ihrem Mein ELSTER Benutzerkonto einloggen, sowohl auf einem PC als auch auf dem Gerät, auf dem ElsterSecure installiert ist. Dazu benötigen Sie:
...
#### Wie richte ich ElsterSecure ein?
...
Zu den App Stores:
        ...
        * [Google Play](https://play.google.com/store/apps/details?id=de.elster.elstersecure.app "Link öffnet neues Fenster")
        * [Apple App Store](https://apps.apple.com/de/app/elstersecure/id1579060331 "Link öffnet neues Fenster")
...
**Hinweis** : Für den Fall, dass Sie Ihr Mobilgerät verlieren, ist es empfehlenswert, dass Sie eine Zertifikatsdatei als zusätzliche Login-Option für Ihr Konto einrichten. So haben Sie auch ohne Ihr Mobilgerät weiterhin Zugang zu Ihrem Konto. Richten Sie dazu nach erfolgreicher Registrierung in Mein ELSTER unter "Mein Benutzerkonto > Zusätzliche Login-Optionen" ein Zertifikat ein. Ohne weitere Login-Option haben Sie bei Verlust die Möglichkeit auf der Login-Seite die Funktion "Smartphone verloren? Zugriff auf Zugangsschlüssel nicht möglich?" zu nutzen. Hierbei erhalten Sie per E-Mail eine neue Aktivierungs-ID und per Post einen neuen Aktivierungsbrief, um wieder einen neuen Zugang zu Ihrem ELSTER-Benutzerkonto zu bekommen.

#### Kann ich ElsterSecure für meine Steuersoftware verwenden?
...
#### Kann ich ElsterSecure für mehrere Konten verwenden?
...
#### Kann ich ElsterSecure auf mehreren Geräten verwenden?
...
#### Wie entferne ich meinen Zugangsschlüssel wieder?

Für die vollständige Entfernung ist es nötig, den Zugangsschlüssel in der App und im Benutzerkonto zu entfernen.
...
#### Was mache ich, wenn mein Gerät verloren geht oder ich ein neues Gerät einrichten möchte?

**Wenn Sie Ihr Gerät verloren haben oder es nicht mehr verwenden können**

Falls Sie Ihr Gerät nicht mehr verwenden können, sollten Sie die Verknüpfung zum Gerät in Ihrem Mein ELSTER Benutzerkonto entfernen. Loggen Sie sich dazu mit einer anderen Zugangsmethode in Mein ELSTER ein und navigieren Sie zu "Mein Benutzerkonto" > "ElsterSecure" > "Login-Option ElsterSecure verwalten". Dort können Sie Ihre verknüpften Geräte einsehen und ggf. löschen.

Wenn Sie keine weitere Zugangsmethode besitzen, müssen Sie Ihren Zugang zu Mein ELSTER erneuern. Gehen Sie dazu zur Login-Seite und klicken Sie auf "Smartphone verloren? Zugriff auf Zugangsschlüssel nicht möglich?". Hierbei werden (sofern nicht anders angegeben) alle bestehenden Zugangsschlüssel umgehend gesperrt.

**Weiteres / neues Gerät hinzufügen**

Möchten Sie ein weiteres Gerät hinzufügen, melden Sie sich in Mein ELSTER an und gehen Sie zu "Mein Benutzerkonto" > "ElsterSecure" > "Login-Option ElsterSecure hinzufügen". Nach dem erfolgreichen Hinzufügen eines neuen Geräts können Sie unter "Login-Option ElsterSecure verwalten" frühere Verknüpfungen löschen.

#### Wie übertrage ich ElsterSecure auf ein neues Gerät?
...
#### Wieso funktioniert der Login nach Entfernen der Displaysperre oder der Fingerprint-Funktion nicht mehr?
...
Haben Sie außer ElsterSecure keine gültige Zugangsmethode, verwenden Sie bitte die Funktion "Zugang erneuern". Gehen Sie dazu zur Login-Seite in Mein ELSTER und klicken Sie auf "Smartphone verloren? Zugriff auf Zugangsschlüssel nicht möglich?" und folgen Sie den dort beschriebenen Schritten. Hierbei erhalten Sie am Ende per E-Mail eine neue Aktivierungs-ID und per Post einen neuen Aktivierungsbrief, um wieder einen neuen Zugang zu Ihrem ELSTER-Benutzerkonto zu bekommen.

#### Ich habe Probleme mit der ElsterSecure-App. Wie bekomme ich Hilfe?
...
#### Kann ElsterSecure auch ohne Displaysperre genutzt werden?

ELSTER empfiehlt nicht, Ihr Gerät ohne Displaysperre zu verwenden. Dennoch ist es möglich, ElsterSecure auch ohne Displaysperre zu nutzen. Hierbei ist es jedoch nötig, bei der Ersteinrichtung ein Passwort festzulegen. Dieses Passwort muss dann bei jedem ELSTER-Login eingegeben werden, um den ElsterSecure-Zugangsschlüssel nutzen zu können.

#### Wieso sehe ich Zugangsschlüssel in ElsterSecure, obwohl ich diese in Mein ELSTER entfernt habe?
...
#### Wie kann ich mich auf dem gleichen Gerät einloggen, auf dem auch die App installiert ist?
...
#### Was sind die Anforderungen zur Nutzung der App?

MeinELSTER+ ist derzeit für Android- und iOS-Smartphones in deutschsprachigen Ländern verfügbar. 

**Mindestanforderungen:**

        * Android-Smartphones und Tablets ab Android 13
        * iPhones und iPads ab iOS 17
...
Bitte loggen Sie sich hierfür parallel mit Ihrer Zertifikatsdatei auf [www.elster.de](http://www.elster.de "Link öffnet neues Fenster") ein.
...
#### Kann MeinELSTER+ auch ohne Displaysperre genutzt werden?
...
####  Was muss ich beim Wechsel auf ein neues Gerät beachten?
...
####  Was kann ich tun, wenn der Text meines Beleges schlecht erkannt wird?
...
#### Was sind keine der Steuerverwaltung vorliegenden Bescheinigungen?
...
#### Kann ich Bescheinigungen auch für vergangene Jahre abrufen?
...
#### Wie autorisiert mich die andere Person, für die ich Bescheinigungen abrufen möchte?
...
#### Was mache ich mit den Bescheinigungen?
...
#### Welche Vorteile habe ich?
        ...
        1. Die vorausgefüllte Steuererklärung hat den Vorteil, dass Sie die Daten nicht mehr eingeben, sondern nur noch überprüfen und ggf. ergänzen müssen. So können Fehler bei der Erfassung der Daten vermieden werden.
        ...
        3. Komfortable Zusatzfunktionen (Hilfefunktion usw.) erleichtern die Erstellung der Steuererklärung.
...
#### Welche Vollmachtnehmer-Typen gibt es?
...
#### Welche Vollmachten können Sonstige Vollmachtnehmer übermitteln?
...
#### Aus welchem Grund wird mir die Funktion "Vollmachten verwalten" nicht angezeigt?
...
Es gibt zurzeit drei Arten, sich bei Mein ELSTER zu registrieren. Diese unterscheiden sich nach dem Gerät oder Medium, worüber die Benutzer-[Authentifizierung](/eportal/helpGlobal?themaGlobal=help_glossary_eop#authf) beim Login durchgeführt wird:
...
Technische Information zu den einzelnen Verfahren finden Sie unter [Datensicherheit/Sicherheitstechnik](/eportal/helpGlobal?themaGlobal=help_datasecurity_eop).
...
Daneben ist die technische Ausstattung Ihres Computers ausschlaggebend. Sie brauchen für  
        ...
        * Sicherheitsstick: einen Sicherheitsstick ([Online-Shop](https://www.sicherheitsstick.de/ "Link öffnet neues Fenster")) und USB-Anschluss

        * Signaturkarte: eine unterstützte Signaturkarte und ein Kartenlesegerät

  
Technische Information zu den einzelnen Verfahren finden Sie unter [Datensicherheit](/eportal/helpGlobal?themaGlobal=help_datasecurity_eop) und [IT-Sicherheit](/eportal/helpGlobal?themaGlobal=help_techsecurity_eop).
...
#### Wo kann ich Aktivierungs-ID und -Code eingeben um meine Registrierung abzuschließen?

Folgen Sie dem Link aus der E-Mail, in der Sie die Aktivierungs-ID erhalten haben. Falls Sie sich nur die Aktivierungs-ID notiert, und die E-Mail anschließend gelöscht haben können Sie folgenden Link verwenden: [Eingabeseite für Aktivierungsdaten](https://www.elster.de/eportal/aktivierung "Link öffnet neues Fenster")   
...
Sie können die Freischaltung Ihres Personalausweises auch mittels der AusweisApp durchführen. Weitere Informationen zur AusweisApp finden Sie unter [https://www.ausweisapp.bund.de](https://www.ausweisapp.bund.de "Link öffnet neues Fenster").
...
Weitere Informationen zum elektronischen Aufenthaltstitel finden Sie unter [http://www.bamf.de/DE/Willkommen/Aufenthalt/eAufenthaltstitel/e-aufenthaltstitel-node.html](http://www.bamf.de/DE/Willkommen/Aufenthalt/eAufenthaltstitel/e-aufenthaltstitel-node.html "Link öffnet neues Fenster").
...
#### Kann ich als Datenübermittler ohne gültiges inländisches Ordnungskriterium Daten authentifiziert übermitteln?
...
#### Für welche Personen/ Fälle ist das Finanzamt Neubrandenburg - RAB zuständig?
...
Füllen Sie den nachstehenden Antrag aus und senden diesen an das Finanzamt Neubrandenburg - RAB. [Antrag auf Erteilung eines Ordnungskriteriums](https://download.elster.de/download/dokumente/Antrag_auf_Erteilung_eines_Ordnungskriteriums.pdf "Link öffnet neues Fenster")  
...
#### Wann sollte ich die Identifikation mit steuerlicher Identifikationsnummer wählen?
...
#### Wann sollte ich die Identifikation mit Steuernummer durchführen?
...
Die IAA-Plus kann nur über das [Zoll-Portal](https://www.zoll.de/DE/Fachthemen/Zoelle/ATLAS/Internetzollanmeldungen/internetzollanmeldungen_node.html "Link öffnet neues Fenster") elektronisch übermittelt werden. Eine elektronische Übermittlung über das ELSTER-Portal ist nicht möglich.
...
[0870 Beteiligte-Stammdaten, Adresserfassung und -benachrichtigung](http://www.zoll.de/DE/Fachthemen/Zoelle/ATLAS/ATLAS-Publikationen/Formulare/formulare.html "Link öffnet neues Fenster") .  
...
#### Erstellung einer berichtigten Grundsteuererklärung
